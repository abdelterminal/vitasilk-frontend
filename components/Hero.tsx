...
const Hero = () => {
 ...
 {/* Mobile: static WebP image */}
 <div className="absolute inset-0 z-0 md:hidden">
 <Image src="/img/hero-mobile.webp" alt="Vitasilk" fill priority sizes="100vw" className="object-cover object-top" style={{filter: 'brightness(0.5) contrast(1.1)'}} />
 ...
 <video autoPlay muted loop playsInline className="w-full h-full object-cover" style={{filter: 'brightness(0.4) contrast(1.1)'}}>
 ...
 <div className="flex items-center justify-center uppercase font-bold mb-2 md:mb-4" style={{color: '#C9A14A'}}>
 <span className="text-primary font-bold uppercase text-[10px] md:text-sm">
 Lissage &amp; Soins Capillaires — Livraison Partout au Maroc
 </span>
 </div>

 <div className="mb-2 md:mb-4 lg:mb-6 text-center">
 <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-white leading-[0.9] tracking-tight" style={{fontFamily: "'Playfair Display', serif"}}>
 <span className="inline-block py-2" style={{fontWeight: 600}}>Cheveux Lisses.</span>
 <br />
 <span className="inline-block py-2" style={{fontWeight: 300}}>Cheveux Brillants.</span>
 </h1>
 </div>

 <p className="text-white/80 text-sm md:text-base max-w-2xl mx-auto mb-6 md:mb-8 lg:mb-10 tracking-wide leading-relaxed" style={{fontWeight: 400}}>
 Des produits professionnels pour lisser et prendre soin de vos cheveux.{' '}

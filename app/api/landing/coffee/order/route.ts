...
import { PRICE_DH } from "@/app/(landing)/coffee/lib/config";
...
export async function POST(request: Request) {
  ...
  await saveOrder("coffee", { name, phone, city, qty, total: order.total, lang: order.lang, at: order.at });

  const endpoint = process.env.SHEETS_ENDPOINT_COFFEE;

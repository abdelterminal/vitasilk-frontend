...
import { PRICE_DH } from "@/app/(landing)/blue-silk/lib/config";
...
export async function POST(request: Request) {
  ...
  await saveOrder("blue-silk", { name, phone, city, qty, total: order.total, lang: order.lang, at: order.at });

  const endpoint = process.env.SHEETS_ENDPOINT_BLUE_SILK;

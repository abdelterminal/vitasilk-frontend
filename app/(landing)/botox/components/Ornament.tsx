/*
 * Signature element: the berber art-deco pattern from the Botox Capillaire
 * label, redrawn as SVG. Used as section dividers and as the frame of the
 * offer card so the page carries the jar's own visual language.
 */
...
export function OrnamentDivider({ className = "" }: { className?: string }) {
  return (
    <div className={`flex items-center justify-center gap-4 ${className}`} aria-hidden>
      ...
      <svg width="120" height="18" viewBox="0 0 120 18" fill="none" className="text-gold">

  ...
  return (
    <section id="problem" className="mx-auto max-w-6xl scroll-mt-20 px-5 py-20 md:py-28">
      <Reveal className="text-center">
        <h2 className="font-display text-3xl text-silk sm:text-4xl md:text-5xl">{t.problem.title}</h2>
        <p className="mx-auto mt-4 max-w-2xl text-silk-dim">{t.problem.subtitle}</p>
      </Reveal>
      ...
      <div className="mt-12 grid gap-8 md:grid-cols-2">
        ...
        <Reveal delay={0.1}>
          <ul className="space-y-4">
            {t.problem.points.map((point) => (
              <li
                key={point}
                className="flex items-center gap-4 rounded-2xl border border-gold/20 bg-navy-light px-5 py-4 text-silk"
              >
        ...
        {/* Promise */}
        <Reveal delay={0.2}>
          <div className="flex h-full flex-col overflow-hidden rounded-2xl border-gold-hairline bg-navy-light shadow-luxe">
            ...
            <div className="flex flex-1 flex-col justify-center p-8">
              ...
              <h3 className="text-center font-display text-2xl text-silk">{t.problem.promiseTitle}</h3>
              <p className="mt-4 text-center leading-relaxed text-silk-dim">{t.problem.promise}</p>
            </div>
          </div>
        </Reveal>
      </div>

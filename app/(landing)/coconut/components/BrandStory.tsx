...
import brandStory from "../assets/images/brand-story-grove.webp";

/**
 * Full-bleed parallax band.
 *
 * Deliberately kept LIGHT. The earlier version inherited the dark theme's
 * scrim (opaque palm-deep at the bottom, 70% through the middle) which dragged
 ...
 * the bottom is veiled in cream, just enough to seat the text.
 */
export function BrandStory() {
  ...
  return (
    ...
    <section
      ref={ref}
      className="relative min-h-[460px] overflow-hidden bg-shell md:aspect-[16/9] md:min-h-0"
    >
      ...
      {/* cream veil over the lower half only — enough to seat palm-deep text
          without touching the top two-thirds of the photograph */}
      <div
        aria-hidden
        className="absolute inset-x-0 bottom-0 h-3/5 bg-gradient-to-t from-cream via-cream/85 to-transparent"
      />
      ...
      <div className="relative flex h-full min-h-[460px] items-end justify-center px-5 pb-10 md:min-h-0 md:pb-14">
        <Reveal className="max-w-xl text-center">
          {/* husk, not gold: at 14px this is small text, and gold-deep only
              reaches 3.8:1 on cream. Matches the Ingredients eyebrow. */}
          ...
          <p className="mx-auto mt-4 max-w-md leading-relaxed text-husk">
